        ...
        <div className="glassmorphism rounded-2xl p-8 md:p-10 border border-brand-purple/20 space-y-8 text-white/80 text-sm leading-relaxed">
          <section>
            ...
            <p>
              ...
              lors de votre visite sur un site web. Il permet de stocker des informations relatives à votre
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs border-collapse">
                ...
                <tbody className="divide-y divide-brand-purple/10">
                  <tr>
                    <td className="p-3 font-medium text-white">Analytics</td>
                    <td className="p-3">Mesure d&rsquo;audience anonymisée (pages visitées, durée, provenance)</td>
                    <td className="p-3">13 mois</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-medium text-white">Préférences</td>
                    <td className="p-3">Mémorisation de votre choix de consentement cookies</td>
                    <td className="p-3">6 mois</td>
                  </tr>
                  <tr>
                    <td className="p-3 font-medium text-white">Fonctionnels</td>
                    <td className="p-3">Maintien de la session et sécurité du site</td>
          ...
          <section>
            ...
            <p>
              Lors de votre première visite, une bannière vous informe de l&rsquo;utilisation des cookies et
              recueille votre consentement. Vous pouvez à tout moment modifier vos préférences en cliquant sur
          ...
          <section>
            ...
            <p className="flex items-center gap-2">
              <Settings size={14} /> Vous pouvez configurer vos préférences via notre bannière de cookies ou
          ...
          <section>
            ...
            <p className="flex items-center gap-2">
              <X size={14} /> Vous pouvez désactiver les cookies depuis les réglages de votre navigateur :
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li>
                <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer"
                   className="text-brand-magenta hover:underline">Google Chrome</a>
              </li>
              <li>
                <a href="https://support.mozilla.org/kb/effacer-cookies" target="_blank" rel="noopener noreferrer"
                   className="text-brand-magenta hover:underline">Mozilla Firefox</a>
              </li>
              <li>
                <a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer"
                   className="text-brand-magenta hover:underline">Safari</a>
              </li>
              <li>
                <a href="https://support.microsoft.com/help/4027947/microsoft-edge-delete-cookies" target="_blank" rel="noopener noreferrer"
                   className="text-brand-magenta hover:underline">Microsoft Edge</a>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Pour toute question relative à notre politique de cookies, écrivez-nous à :{" "}
              <strong className="text-white">contact@art-visions.fr</strong>
            </p>
          </section>
        </div>
      </div>
